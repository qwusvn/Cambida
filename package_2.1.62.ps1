...
- This is a staging onedir build with Cloudflared and complete Python dependencies bundled.
...
"@ | Set-Content -LiteralPath (Join-Path $Stage "README_FIRST_RUN.txt") -Encoding UTF8
    ...
    $Required = @(
        ...
        "live_all.html","stats.html","timeline.html","1.py","ffmpeg.exe","cloudflared.exe","updater.cmd",
