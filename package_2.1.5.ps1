...
try {
    ...
    Write-Host "[2/6] Staging build artifacts..." -ForegroundColor Cyan
    ...
    $hashFiles = @("1.py","index.html","admin.html","home.html","$Name.spec","config.release.json","RELEASE_VERSION.txt","updater.cmd")
