...
if "%EXE%"=="" (
  if exist "%ROOT%release\2.1.61\CCTV_2.1.61.exe" set "EXE=%ROOT%release\2.1.61\CCTV_2.1.61.exe"
  if exist "%ROOT%staging\2.1.61\CCTV_2.1.61.exe" set "EXE=%ROOT%staging\2.1.61\CCTV_2.1.61.exe"
)
