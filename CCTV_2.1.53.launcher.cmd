...
setlocal
set "ROOT=%~dp0"
set "EXE=%ROOT%CCTV_2.1.53.exe"
if not exist "%EXE%" set "EXE=%ROOT%release\2.1.53\CCTV_2.1.53.exe"
if not exist "%EXE%" set "EXE=%ROOT%staging\2.1.53\CCTV_2.1.53.exe"
set "URL=http://127.0.0.1:8004/"

if not exist "%EXE%" (
  echo Khong tim thay CCTV_2.1.53.exe
  pause
  exit /b 1
)
