...
setlocal
set "ROOT=%~dp0"
set "EXE=%ROOT%CCTV_2.1.60.exe"
if not exist "%EXE%" set "EXE=%ROOT%release\2.1.60\CCTV_2.1.60.exe"
if not exist "%EXE%" set "EXE=%ROOT%staging\2.1.60\CCTV_2.1.60.exe"
set "URL=http://127.0.0.1:8004/"

if not exist "%EXE%" (
  echo Khong tim thay CCTV_2.1.60.exe
  pause
  exit /b 1
)
