...
if "%EXE%"=="" (
  if exist "%ROOT%release\2.1.62\CCTV_2.1.62.exe" set "EXE=%ROOT%release\2.1.62\CCTV_2.1.62.exe"
  if exist "%ROOT%staging\2.1.62\CCTV_2.1.62.exe" set "EXE=%ROOT%staging\2.1.62\CCTV_2.1.62.exe"
)
